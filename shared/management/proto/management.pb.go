...
const file_management_proto_rawDesc = "" +
	...
	"\bpassword\x18\x03 \x01(\tR\bpassword\"\xfd\x02\n" +
	"\n" +
	"PeerConfig\x12\x18\n" +
	...
	"autoUpdate\x12(\n" +
	"\x10login_expires_at\x18\t \x01(\x03R\x0eloginExpiresAt\"R\n" +
	...
	"\x0etranslatedPort\x18\x04 \x01(\v2\x14.management.PortInfoR\x0etranslatedPort\"\xea\x01\n" +
